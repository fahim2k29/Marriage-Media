                        ...
                        <div class="row setting-bgcolor roundcornerPanel">
                            <div class="col-md-3 col-lg-3 nopaddingleft">
                                ...
                                <nav class="nav-sidebar searchLeftnav">
                                    <ul class="nav tabs">
                                        ...
                                        <li class="active">
                                            <a data-toggle="tab" href="/search" data-title="Quick" aria-expanded="true" class="current">
                                        ...
                                        <li class="">
                                            <a data-toggle="tab" href="/religion" data-title="Religion" aria-expanded="false" class="current">
                                                <div class="pull-left serachBaricon">
                                        ...
                                        <li class="">
                                            <a data-toggle="tab" href="/education" data-title="Education">
                                                <div class="pull-left serachBaricon">
                                        ...
                                        <li class="">
                                            <a data-toggle="tab" href="/personal" data-title="Personal" aria-expanded="false" class="current">
                                                <div class="pull-left serachBaricon">
                            ...
                            <div class="col-md-9 col-lg-9 minheightprofile boxforms">
                                ...
                                <div id="signupbox" class="col-md-11 col-lg-11 leftmargin boxforms">
                                    <form id="frmsearchMain" class="form-horizontal" role="form" action="/searchdisplayresults" method="post" data-select2-id="frmsearchMain">
                                    ...
                                    -->
                                            ...
                                            <div class="tab-pane text-style" id="tab4" data-counter="0">
                                                <div class="panel panel-info" style="border: 0px; box-shadow: 0 0px 0px rgba(0, 0, 0, 0.05);" data-select2-id="1261">
                                                    <!--
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            Search Personal
                                    ...
                                    -->
                                                    <div class="panel-body" data-select2-id="1260">
                                                        <div role="form" class="form-horizontal" data-select2-id="1259">
                                                            ...
                                                            <div id="HaveChildren-group" class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group input-group-maxwidth">
                                                                        ...
                                                                        <span class="select2 select2-container select2-container--default select2-container--below" dir="ltr" data-select2-id="1243" style="width: 100px;">
                                                                            <span class="selection">
                                                                                <span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1">
                                                                                    <ul class="select2-selection__rendered">
                                                                                        <li class="select2-search select2-search--inline">
