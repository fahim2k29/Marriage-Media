...
<script type="text/javascript" async="" src="https://www.google-analytics.com/plugins/ua/ec.js"></script><script src="https://connect.facebook.net/signals/config/2251928191696851?v=2.9.22&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-NNGBZLJ"></script><script type="application/ld+json" data-json="webSchema" class="ng-binding ng-isolate-scope">{
...
<meta name="Author" content="Single Muslim">
    ...
    <link href="/css/less/controller/UserController.css" media="screen" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="/js/global.min.js"></script>
    <script type="text/javascript" src="/js/controller/UserController.min.js"></script>
...
<nav class="navbar navbar-default" id="mainTopnav" style="">

    <div class="row-fluid">


        <div class="top_loginbar navbar-fixed-top" style="width: 100%;margin: 0px; border: 0px;">
            ...
            <div class="container">
                ...
                <div class="col-md-2 col-lg-2 logo_topbar">
                    ...
                    <div class="abslogo_position1">
                        <!--<a href="/dashboard">-->
                            <img src="/images/header-logo.gif" border="0" style="display: inline-block; height: 60px;">
                        <!--</a>-->
                ...
                <div class="col-md-10 col-lg-10 logo_topbar">
                    ...
                    <div class="login_innerbar ">
                        ...
                        <div class="topnav_bar steps_navbar">
                 ...
                 <div class="modal-content">
                     <div class="modal-header">
                         ...
                         <div class="notificationheading span12" style="text-align: center;width:100%">
                             ...
                             <div class="filtericon">
                                 ...
                                 </select><span class="select2 select2-container select2-container--default select2width" dir="ltr" data-select2-id="7" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-filter-container"><span class="select2-selection__rendered" id="select2-filter-container" role="textbox" aria-readonly="true" title="
                                         Show All
                                     ">
                                         Show All
                     ...
                     <div class="modal-body">
                                 ...
                                 <div class="photoBoxHolder2  ">
                                     ...
                                     <div class="notifications customheight">
                    ...
                    <div id="aboutyoubox" class="stepsbox ">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="signupform" class="form-horizontal" role="form" action="/aboutyousubmit" method="post" data-toggle="validator" novalidate="true">
...
<div role="form" class="form-horizontal">
                    ...
                    <div id="Headline-group" class="form-group has-feedback form-control-group">
                        ...
                        <div class="controls">
                             <input name="Headline" id="Headline" type="text" required="required" value="asergy" class="form-control">
                        </div>
                        <span id="Headline-span-success" class="smicon-new form-control-feedback  smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="Create a short strap-line for your profile."></span>
                    ...
                    <div id="Description-group" class="form-group has-feedback form-control-group">
                        ...
                        <div class="controls">
                             <textarea name="Description" id="Description" required="required" class="form-control" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 54px;">sertg</textarea>
                        </div>
                        <span id="Description-span-success" class="smicon-new form-control-feedback  smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="Please describe yourself. You can include information about your hobbies and interests; family; occupation etc. "></span>
                        <span class="help-block with-errors" aria-hidden="true"></span>
                    </div>
                    ...
                    <div id="LookingFor-group" class="form-group has-feedback form-control-group">
                        ...
                        <div class="controls">
                             <textarea name="LookingFor" id="LookingFor" required="required" class="form-control" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 54px;">seryga</textarea>
                        </div>
                        <span id="LookingFor-span-success" class="smicon-new form-control-feedback  smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="Please describe the type of person you are looking for. "></span>
                        <span class="help-block with-errors" aria-hidden="true"></span>
                    </div>
                ...
                <div class="col-sm-offset-0 col-sm-12 textalignright">
                  <button name="Submit" id="Submit" type="submit" class="btn btn-primary btn-lg textalignright">Next</button>
                    ...
                    <div style="margin-top:-50px; position: absolute;">
                        {!! HTML::linkRoute('register/aboutyou', 'Previous',array(),array('class'=> 'btn btn-default')) !!}
                                            </div>
                                            -->
                                </form>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-10 col-lg-10">
                    ...
                    <p>Copyright ©  Single Muslim. All rights reserved. All third party logos are for illustration only and are copyright of their respective owners.</p>
...
<div class="site-overlay"></div>
      ...
      <script type="text/javascript" id="">!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version="2.0",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init","2251928191696851");fbq("trackCustom","PageViewDesktop");</script>
