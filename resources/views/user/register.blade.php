    ...
    <div class="panel-body">
     <form method="POST" action="{{ route('register' ) }}">
      ...
      <div id="Email-group" class="form-group has-feedback form-control-group">
       ...
       <span id="Email-span-success" class="smicon-new form-control-feedback  male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="Your Verification Code will be sent to this Email">
        <i class="fa fa-info-circle" aria-hidden="true"></i>
       </span>
