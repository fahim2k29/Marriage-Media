    ...
    <div class="panel-body">
     <form method="POST" action="{{ route('register' ) }}">
      ...
      <div id="Email-group" class="form-group has-feedback form-control-group">
       ...
       <span id="Email-span-success" class="smicon-new form-control-feedback smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="Your password will be sent to this Email"></span>
       <span class="help-block with-errors" aria-hidden="false"></span>
       <div class="clearfix"></div>
      </div>
      ...
      <div id="ConfirmEmail-group" class="form-group has-feedback form-control-group">
       ...
       <span id="ConfirmEmail-span-success" class="smicon-new form-control-feedback smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="" style="display: none;"></span>
       <span class="help-block with-errors" aria-hidden="false"></span>
       <div class="clearfix"></div>
      </div>
      ...
      <div id="Country-group" class="form-group has-feedback form-control-group">
       ...
       <div class="controls">
        <select name="Country" id="Country" required="required" data-error="Please fill out this field." data-select2-id="Country" tabindex="-1" aria-hidden="true">
       ...
       {{-- <span id="Country-span-success" class="smicon-new form-control-feedback smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="" style="display: none;"></span> --}}
       <span class="help-block with-errors" aria-hidden="false"></span>
       <div class="clearfix"></div>
      </div>
      ...
      <div id="RegistrationReason-group" class="form-group has-feedback form-control-group">
       ...
       {{--
       <span id="RegistrationReason-span-success" class="smicon-new form-control-feedback smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="" style="display: none;"></span> --}}
       <span class="help-block with-errors" aria-hidden="false"></span>
       <div class="clearfix"></div>
      </div>
      ...
      <div id="HearAboutUs-group" class="form-group has-feedback form-control-group">
       ...
       {{-- <span id="HearAboutUs-span-success" class="smicon-new form-control-feedback smicon-info male span-info-label" data-toggle="tooltip" data-placement="right" title="" data-original-title="" style="display: none;"></span>
       <span class="help-block with-errors" aria-hidden="false"></span> --}}
       <div class="clearfix"></div>
      </div>
