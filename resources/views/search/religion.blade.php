             ...
             <div class="panel-body">
              <div role="form" class="form-horizontal">
               ...
               <div id="Religiosness-group" class="form-group">
                ...
                <div class="col-sm-8">
                 <div class="input-group input-group-maxwidth">
                  <select name="Religiosness" id="Religiosness" data-placeholder="Select your option" class="select2-hidden-accessible" data-select2-id="Religiosness" tabindex="-1" aria-hidden="true">
                   <option>Select Option</option>
                   @foreach ($religiondatas as $religiondata)
