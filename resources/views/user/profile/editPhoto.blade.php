      ...
      <div class="row setting-bgcolor roundcornerPanel">
       <div class="col-lg-3 col-md-3 nopaddingleft">
        <nav class="secondFont breadcrumbs-newstyle settingbreadcrumbChange" style="">
         ...
         <i class="smicon-new smicon-angle-right"></i>
         <a href="/editPhoto" id="changeBreadcrum" class="breadcrumLast">Edit My Photos</a>
        </nav>
        <nav class="nav-sidebar">
         <ul class="nav">
          ...
          <li class="bottombodernone">
           <a href="#"> <i class="sm-line basic-alarm sm-nav-dropdown-icons"></i>Notifications / Preferences <span class="smicon-new smicon-angle-right pull-right arrow-font-size"></span> </a>
          </li>
            ...
            <div class="panel-body">
             <ul class="row primary">
              <div class="view view-sixth">
               <img src="{{asset('frontend/assets/images/')}}/{{ $addPhoto->image }}" />
               ...
               <div class="mask">
                ...
                <div class="col-lg-12" style="margin-top: 40px;">
                 <a href="#" class="info btn-info btn-makeaspublic" data-pictype="public" data-pickey="ZGEwNmU4OWZlZjY3ODI4Y9MljcTGyexSHTn8OF-3yu79_vAW6DS6QSMPzVHMfFBZ$"> <i class="smicon-new smicon-unlock"></i>&nbsp;&nbsp;Make Public </a>
                </div>
                <div class="col-lg-12">
                 <a href="#" class="info btn-info btn-makeasprivate" data-pictype="private" data-pickey="ZGEwNmU4OWZlZjY3ODI4Y9MljcTGyexSHTn8OF-3yu79_vAW6DS6QSMPzVHMfFBZ$"> <i class="smicon-new smicon-lock"></i>&nbsp;&nbsp;Make Private </a>
                </div>
             ...
             <ul class="row public">
              <div class="view view-sixth">
               ...
               <div class="mask">
                ...
                <div class="col-lg-12">
                 <a href="#" class="info btn-info btn-makeasprivate" data-pictype="private" data-pickey="ZGEwNmU4OWZlZjY3ODI4Yz6RP8JeIYVefYHYd5O_f3Nn50Y8Ci8x-sgnj62XIgI5$"> <i class="smicon-new smicon-lock"></i>&nbsp;&nbsp;Make Private </a>
                </div>
              ...
              <li class="view view-sixth view-drop">
               <div class="panel panel-success dragbox-div dragbox-public-div dropzone dz-clickable" data-imagetype="public" data-showdialog="false" style="width: 100%; float: right; min-height: 241px;">
          ...
          <div class="panel panel-primary panel-private" style="margin-bottom: 1px; border: 0px;">
           ...
           <div class="panel-body">
            <ul class="row private">
             <li class="view view-sixth view-drop">
              <div class="panel panel-success dragbox-div dragbox-private-div dropzone dz-clickable" data-isregister="false" data-imagetype="private" data-showdialog="false" style="width: 100%; float: right; min-height: 241px;">
